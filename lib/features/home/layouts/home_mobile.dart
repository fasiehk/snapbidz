...
/// Original mobile home screen — extracted verbatim from home_screen.dart.
                  ...
                  SizedBox(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        return _CategoryChip(label: cat.name, icon: cat.icon, isActive: i == 0);
                      },
                    ),
                  ),
                ],
...
// ── Shared sub-widgets (private to mobile layout) ─────────────────────────────
    ...
    return AnimatedContainer(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(label, style: AppTextStyles.labelMedium.copyWith(color: isActive ? AppColors.onPrimary : AppColors.onSurface)),
        ],
      ),
    );
  }
...
class _TrendingCard extends StatelessWidget {
  ...
  String _formatCurrency(int value) => value >= 1000 ? 'PKR ${(value / 1000).toStringAsFixed(1)}k' : 'PKR $value';
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Builder(builder: (ctx) {
                        final total = auction.endTime.difference(auction.createdAt).inSeconds;
                        final elapsed = DateTime.now().difference(auction.createdAt).inSeconds;
                        final progress = (total > 0 ? elapsed / total : 1.0).clamp(0.0, 1.0);
